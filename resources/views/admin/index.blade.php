        ...
        <div class="container mt-3">
            ...
            <div class="row">
                ...
                <div class="col mx-3 my-3 bg-secondary d-flex align-items-center justify-content-center"
                    ...
                    <a class="text-decoration-none fs-2 text-center text-dark" href="{{ url('/dakes') }}">Pemantauan
                        Kesehatan</a>
                </div>
                <div class="col mx-3 my-3 bg-secondary d-flex align-items-center justify-content-center">
                    <a class="text-decoration-none fs-2 text-center text-dark" href="{{ url('/jurkes') }}">Jurnal
                        Perawatan</a>
                </div>
                <div class="col mx-3 my-3 bg-secondary d-flex align-items-center justify-content-center"
                    style="height: 200px; width: 200px; border-radius: 15px;">
                    <a class="text-decoration-none fs-2 text-center text-dark" href="{{ url('/dokumed') }}">Dokumen
                        Medis</a>
                </div>
            </div>
            <h5>Edit Artikel</h5>
